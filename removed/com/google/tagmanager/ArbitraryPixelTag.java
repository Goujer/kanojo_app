		...
		if (unrepeatableId == null || !idProcessed(unrepeatableId)) {
			...
			if (additionalParamsList != null) {
				...
				for (Object m : (List) l) {
					...
					for (Object entry : ((Map) m).entrySet()) {
						Map.Entry<Object, Object> entry1 = (Map.Entry<Object, Object>) entry;
						uriBuilder.appendQueryParameter(entry1.getKey().toString(), entry1.getValue().toString());
					}
				}
			}
